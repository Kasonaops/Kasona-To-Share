...
> **How to use it, in three steps:** open [prompt.txt](prompt.txt), copy all of it into a new Claude chat, and replace the placeholders (your code, your error message, what you were trying to do). Send. More help: [GETTING-STARTED.md](../../GETTING-STARTED.md).
